  ...
  const fetchAudio = async (str: string) => {
    ...
    const options = {
      ...
      headers: {
        ...
        Authorization:
          "Bearer ya29.a0AfB_byCxGHZnyzwpNbM-qMITKAnT2NpTitYEzw07bEqF1GZ3mZMuv9IcCq5ah7ubx_J6iXIwEGGDALDLZZcyXlAfFyAxC0OZnH9dxZQTbeCrBj71sbLZeeMfe9mrRFi52g4tvk2N7hLXcWiOpWJ5N1LBFAuodDDT9552mgMBcCnmaCgYKAVcSARESFQHGX2MixtxivYbXHVhcAXg07WwHkA0179",
      },
      body: JSON.stringify({
        input: { text: str },
        voice: {
